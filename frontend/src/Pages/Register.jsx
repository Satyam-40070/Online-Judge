...
const Register = () => {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            navigate('/'); // Navigate to the homepage or another route on successful registration
        } catch (err) {
            if (err.response) {
  ...
  return (
    <div className="m-container h-[91.7vh] flex justify-center items-center bg-cover" >
        <div className="wrapper text-white bg-slate-800 border border-slate-400 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-30 relative">
            ...
            <div className='relative my-4'>
                <input type="password" onChange={(e)=> setPassword(e.target.value)} className='block w-72 py-2.3 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0  focus:text-white focus:border-blue-600 peer' placeholder=''/>
